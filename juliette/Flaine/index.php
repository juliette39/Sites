<?php
	...
	if ( !isset($_GET['personne']) || empty($_GET['personne']) ||  !array_key_exists($_GET['personne'], $personnes))
	{
		$personne = "Tous";
	}
	else
	{
		...
		$personne_url = $_GET['personne'];
		$personne = str_replace("_", " ", $personne_url);
	}
?>
			...
			<div id="wrapper">
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="https://www.debono.fr/juliette/Flaine/index.php?personne=À_apporter#intro" class="active">À apporter</a></li>
						</ul>
					</nav>
							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<form method="post" action="<?php echo "https://www.debono.fr/juliette/Flaine/del.php?personne=$personne_url";?>#intro">

										    <?php
										    try {
							                	tout_objets($personne_url);
							                	}
							                catch (Exception $e)
												{
